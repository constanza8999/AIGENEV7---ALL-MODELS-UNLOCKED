...
export const FREEBUFF_FABLE5_MODEL_ID = 'anthropic/claude-fable-5'
...
const FABLE5_MODEL = {
  id: FREEBUFF_FABLE5_MODEL_ID,
  displayName: 'Fable 5',
  tagline: 'Smartest & Multimodal',
  availability: 'always',
  // No data-collection warning: Anthropic doesn't train on API data.
  // Omitting the warning also keeps it out of FREEBUFF_TRACED_MODEL_IDS.
  // Unlimited (non-premium) — no daily session cap.
  premium: false,
  multimodal: true,
...
/** All models are now unlimited — no premium tier. */
