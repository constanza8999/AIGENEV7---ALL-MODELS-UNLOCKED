...
export const getFreeModeUnavailableErrorMessage = (
  ...
  if (block?.countryBlockReason === 'anonymous_network') {
    return `${IS_FREEBUFF ? 'AiGen7Ev' : 'Free mode'} cannot be used from ${formatFreebuffHardBlockedPrivacySignals(
...
export const FREEBUFF_RATE_LIMIT_MESSAGE =
  'AiGen7Ev is temporarily busy. Please try again in a moment.'

export const FREE_MODE_UNAVAILABLE_MESSAGE = IS_FREEBUFF
  ? 'AiGen7Ev is not available in your country.'
